...
```javascript
someInBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-some-in-by@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/object-some-in-by/tags). For example,

```javascript
someInBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-some-in-by@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var someInBy = require( 'path/to/vendor/umd/object-some-in-by/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/object-some-in-by@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/object-some-in-by.svg
[npm-url]: https://npmjs.org/package/@stdlib/object-some-in-by

[test-image]: https://github.com/stdlib-js/object-some-in-by/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/object-some-in-by/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/object-some-in-by/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/object-some-in-by?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/object-some-in-by.svg
[dependencies-url]: https://david-dm.org/stdlib-js/object-some-in-by/main
...
[branches-url]: https://github.com/stdlib-js/object-some-in-by/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/object-some-in-by/main/LICENSE
